...
class YahooCollector():
    ...
    def get_closing_price(self):
        price = utils.del_str(self.realtime_block.select("header .StyledNumber__value__3rXW")[0].get_text(),",")
    ...
    def get_open_price(self):
        ...
        price = utils.del_str(o_b.select("dd .StyledNumber__value__3rXW")[0].get_text(), ",")
        if not utils.int_check(price):
            return ""
        return price
    ...
    def get_credit_unpurchased(self):
        ...
        amount = utils.del_str(m_b.select("dd .StyledNumber__value__3rXW")[0].get_text(), ",")
    ...
    def get_issued_shares(self):
        ...
        shares = utils.del_str(r_b.select("dd .StyledNumber__value__3rXW")[0].get_text(), ",")
    ...
    def get_dividend(self):
        ...
        dividend = r_b.select("dd .StyledNumber__value__3rXW")[0].get_text()
        return dividend

    def get_PER(self):
        r_b = self.referenc_block.select("ul li")[4]
        per = r_b.select("dd .StyledNumber__value__3rXW")[0].get_text()
    ...
    def get_PBR(self):
        ...
        pbr = r_b.select("dd .StyledNumber__value__3rXW")[0].get_text()
    ...
    def get_EPS(self):
        ...
        eps = r_b.select("dd .StyledNumber__value__3rXW")[0].get_text()
    ...
    def get_BPS(self):
        ...
        bps = r_b.select("dd .StyledNumber__value__3rXW")[0].get_text()
